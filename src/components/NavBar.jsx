...
function NavBar({ auth, setUser, pageBody, setPageBody, week, day }) {
  const profileButton = (
    <button className="btn btn-ghost btn-circle" onClick={() => setPageBody('Profile')}>
      <svg className="w-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
  ...
  return (
    <div className="navbar bg-base-100">
      ...
      <div className="navbar-center">
        <a className="btn btn-ghost text-xl" onClick={() => setPageBody('Lifts')}>W{week} D{day}</a>
      </div>

      <div className="navbar-end">
        <button className="btn btn-ghost btn-circle" title="log out" onClick={logOut}>
          <svg className="w-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256"><path fill="currentColor" d="M232 216h-24V40a16 16 0 0 0-16-16H64a16 16 0 0 0-16 16v176H24a8 8 0 0 0 0 16h208a8 8 0 0 0 0-16ZM192 40v176h-16V40ZM64 40h96v176H64Zm80 92a12 12 0 1 1-12-12a12 12 0 0 1 12 12Z"></path></svg>
        </button>
      </div>
